...
import com.nadya.pengembalian_service.vo.Anggota;
import com.nadya.pengembalian_service.vo.Buku;
import com.nadya.pengembalian_service.vo.Peminjaman;// Corrected VO import
...
public class PengembalianService {
    ...
    // Fetch Peminjaman details to get the expected return date
        ...
        if (peminjaman != null && peminjaman.getTanggalPengembalian() != null) {
            ...
            LocalDate actualReturnDate = pengembalian.getTanggal_dikembalikan();
